...
> **These specs target the finished app (`main`).** On the `starter` branch most fail because routing, the DatePicker, and validation aren't wired up yet. They go green as the modules are completed — useful as a red→green progress signal.
