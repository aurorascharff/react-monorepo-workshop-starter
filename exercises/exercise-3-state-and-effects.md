...
Some state is duplicated, some state can become impossible, and some state survives longer than it should. In this exercise, clean up the state so the UI follows the data more directly.
